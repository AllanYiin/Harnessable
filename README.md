...
- [Agentic harness roadmap spec](docs/agentic-harness-roadmap-spec.md)
- [Audit package](docs/audit-package.md)
- [ToolAnything gateway contract](docs/toolanything-gateway-contract.md)
- [Lineage envelope](docs/lineage-envelope.md)
- [Trace promotion](docs/trace-promotion.md)
- [Identity and secret audit](docs/identity-secret-audit.md)
- [Observability and deployment adapters](docs/observability-deployment-adapters.md)
- [Scenario benchmark suite](docs/scenario-benchmark-suite.md)
- [Compliance support and vertical packs](docs/compliance-support-vertical-packs.md)
