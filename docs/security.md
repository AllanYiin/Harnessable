...
- Imports are previewed before apply; preview enforces import-root allowlists,
  supported file suffixes, byte limits, binary sniffing, schema validation, and
  source-hash revalidation before apply.
